...
/// [`Contract`] allowing [`User`] to rent a [`Realty`].
#[derive(Clone, Debug)]
pub struct Rent {
    /// ID of this [`Contract`].
    pub id: Id,
    ...
    /// ID of the [`Realty`] this [`Contract`] allows to rent.
    ...
    /// Deposit paid by the purchaser at the moment of signing, if any.
